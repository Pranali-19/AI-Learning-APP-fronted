...
const QuizCard = ({quiz , onDelete }) => {
  return (
    <div className='group relative bg-white/50 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-4 transition-all duration-200 hover:shadow-lg hover hover:shadow-emerald-500/20 flex flex-col justify-between'>
      <button
        onClick={(e) => {
          e.stopPropagation();
          onDelete(quiz);
