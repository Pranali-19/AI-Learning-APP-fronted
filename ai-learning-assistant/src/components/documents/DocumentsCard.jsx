...
const DocumentsCard = ({document, onDelete}) => {
  ...
  return <div
    className='group relative bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-2xl p-5 hover:border-slate-300/60 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 flex flex-col justify-between cursor-pointer hover:-translate-y-10'
    ...
    >
        ...
        <div className='flex items-start justify-between gap-2 mb-4'>
            ...
            <button
              ...
              className='opacity-0 group-hover:opacity-100 w-8 flex items-center justify-center text-slate-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all duration-200'
            >
        ...
        <div className='mt-5 pt-4 border-t border-slate-100'>
            <div className='flex items-center gap-1.5 text-xs text-slate-500'>
                ...
                <span>Uploaded {moment(document.createAt).fromNow()}</span>
            </div>
        </div>

        {/* Hover Indictor */}
        <div className='absolute inset-0 rounded-2xl bg-linear-to-br from-emerald-500/0 group-hover:from-emerald-500/50 group-hover:to-teal-500/5 transition-all duration-300 pointer-events-none' />
    </div>
