...
const FlashcardManager = ({documentId}) => {
    ...
    const fetchFlashcardSets = async () => {
        ...
        try {
            ...
            toast.error("Failed to fetch flash sets.");
            console.error(error);
        } finally {
            setLoading(false);
        }
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
                    {flashcardSets.map((set) => (
                        <div
                           ...
                           className='group relative bg-white/80 backdrop-blur-xl border-2 border-slate-200 hover:border-emerald-300 rounded-2xl p-6 cursor-pointer transition-all duration-200 hover:shadow-lg hover:shadow-emerald-500/20'
                        >
                            {/* Delete Button */}
                            <button
                            ...
                            >
                                <Trash2 className='w-4 h-6' strokeWidth={2} />
                            </button>
    ...
    >
        <div className='space-y-6'>
            <p className='text-sm text-slate-600'>
                ...
                This action cannot be undone and all cards will be permanently removed.
            </p>
            <div className='flex items-center justify-end gap-3 pt-2'>
                <button
                  ...
                  onClick={deleting}
                  disabled={deleting}
                  className='px-5 h-12 bg-slate-100 hover:bg-slate-200 text-slate-700 font-medium text-sm rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed'
                >
                    Cancel
                </button>
                <button
