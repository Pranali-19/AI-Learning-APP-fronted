    ...
    >
        <div className='space-y-4'>
            ...
            <div className='flex items-start gap-4'>
                <div className='shrink-0 w-12 h-12 rounded-xl bg-linear-to-r from-emerald-100 to-teal-100 flex items-center justify-center'>
        ...
        <div className='mt-6 pt-4 border-t border-slate-100'>
            ...
            >
                <span className='releative z-10 flex items-center justify-center gap-2'>
