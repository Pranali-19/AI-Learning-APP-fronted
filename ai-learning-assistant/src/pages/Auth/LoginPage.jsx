...
const LoginPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setError(error.message || 'Failed to login. Please cheak your credentials.');
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-linear-to-br from-slate-50 via-white to-slate-50'>
      ...
      <div className='absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] bg-size-[16px_16px] opacity-30' />
        ...
        <div className='releative w-full max-w-md px-6'>
        ...
        {/* Email Field */}
          <div className='space-y-2'>
            ...
            <div className='relative group'>
              ...
              <input 
                ...
                className='w-full h-12 pl-12 pr-4 border-2 border-slate-200 rounded-xl bg-slate-50/50 text-slate-900 placeholder-slate-400 text-sm font-medium transition-all duration-200 focus:outline-none focus:border-emerald-500 focus:bg-white focus:shadow-lg focus:shadow-emarald-500/10'
              />
            </div>
          </div>
          ...
          <div className='space-y-2'>
            ...
            <div className='relative group'>
              <div className={`absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-colors duration-200 ${
                focusedField === 'password' ? 'text-emeraild-500' : 'text-slate-400'
            }`}>
          ...
          >
            ...
            <div className='absolute inset-0 bg-liner-to-r from-white/0 via-white/20 to-white/0 -translate-x-full group-hover:translate-x-full transition-transform duration-700'/>
          </button>
          </div>
